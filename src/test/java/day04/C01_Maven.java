...
public class C01_Maven {
    public static void main(String[] args) throws InterruptedException {
        ...
        List<WebElement> headers = driver.findElements(By.xpath("(//span[@class='a-size-medium a-color-base a-text-normal'])"));

        for (int i = 1; i < headers.size(); i++) {
            System.out.println(i + ".product number : " + headers.get(i).getText());
        }
        driver.quit();
